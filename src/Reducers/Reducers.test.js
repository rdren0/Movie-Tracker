...
describe("currentUserReducer", () => {
  it("should update current user on Login", () => {
    ...
    const result = currentUserReducer(
      initialState,
      actions.userLogin(expected)
    );
    expect(result).toEqual(expected);
  });
});
...
describe("favoritesReducer", () => {
  it("should set a movie as favorite", () => {
    ...
    const result = favoritesReducer(
      initialState,
      actions.setFavorites(mockFavoriteResponse)
    );
    expect(result).toEqual(expected);
  });
});
...
describe("moviesReducer", () => {
  it("should add movies to state", () => {
    ...
    const result = moviesReducer(
      initialState,
      actions.addMovies(mockDataResponse)
    );
    expect(result).toEqual(expected);
  });
});
